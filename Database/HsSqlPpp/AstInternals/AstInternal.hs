    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _selOlib :: LocalIdentifierBindings
              ...
              -- "./TypeChecking/Expressions.ag"(line 237, column 9)
              _backTree =
    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _argsOlib :: LocalIdentifierBindings
              ...
              -- "./TypeChecking/Expressions.ag"(line 148, column 9)
              _tpe =
                  {-# LINE 148 "./TypeChecking/Expressions.ag" #-}
    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _exprsOlib :: LocalIdentifierBindings
              ...
              -- "./TypeChecking/Expressions.ag"(line 282, column 9)
              _lhsOlistType =
                  {-# LINE 282 "./TypeChecking/Expressions.ag" #-}
    ...
    (\ _lhsIinProducedEnv ->
         (let _sourceOlib :: LocalIdentifierBindings
              ...
              _annotatedTree =
                  ...
                  {-# LINE 9428 "AstInternal.hs" #-}
              -- self rule
              _lhsOannotatedTree =
                  {-# LINE 57 "./TypeChecking/TypeChecking.ag" #-}
                  _annotatedTree
                  {-# LINE 9433 "AstInternal.hs" #-}
              -- self rule
              _originalTree =
                  {-# LINE 63 "./TypeChecking/TypeChecking.ag" #-}
