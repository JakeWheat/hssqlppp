...
--   files to definitions in earlier files. This is probably easier if you
--   parse the files then concatenate the statementlists together before
--   type checking.
