    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _justOlib :: LocalIdentifierBindings
              ...
              -- "./TypeChecking.ag"(line 976, column 12)
              _lhsOexprType =
    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _lhsOannotatedTree :: MaybeExpression
              ...
              -- "./TypeChecking.ag"(line 977, column 15)
              _lhsOexprType =
    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _tlOenv :: Environment
              ...
              -- "./TypeChecking.ag"(line 923, column 13)
              _lhsOparams =
    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _lhsOannotatedTree :: ParamDefList
              ...
              -- "./TypeChecking.ag"(line 922, column 12)
              _lhsOparams =
    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _checkOlib :: LocalIdentifierBindings
              ...
              ( _typIannotatedTree,_typInamedType) =
                  (typ_ _typOenv _typOlib )
              -- "./TypeChecking.ag"(line 877, column 9)
              _envUpdates =
                  {-# LINE 877 "./TypeChecking.ag" #-}
                  [EnvCreateDomain (ScalarType name_) _typInamedType]
                  {-# LINE 6878 "AstInternal.hs" #-}
              -- "./TypeChecking.ag"(line 876, column 9)
              _statementInfo =
              ...
              -- "./TypeChecking.ag"(line 875, column 9)
              _backTree =
    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _valueOlib :: LocalIdentifierBindings
              ...
              -- "./TypeChecking.ag"(line 991, column 9)
              _tpe =
                  {-# LINE 991 "./TypeChecking.ag" #-}
    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _tlOenv :: Environment
              ...
              -- "./TypeChecking.ag"(line 854, column 12)
              _lhsOattrs =
    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _lhsOannotatedTree :: TypeAttributeDefList
              ...
              -- "./TypeChecking.ag"(line 855, column 11)
              _lhsOattrs =
    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _typOenv :: Environment
              ...
              -- "./TypeChecking.ag"(line 952, column 14)
              _lhsOdef =
    ...
    (\ _lhsIenv
       _lhsIlib ->
         (let _lhsOannotatedTree :: VarDefList
              ...
              -- "./TypeChecking.ag"(line 956, column 11)
              _lhsOdefs =
