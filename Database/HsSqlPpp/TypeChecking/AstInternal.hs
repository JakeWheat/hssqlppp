...
{-# LINE 664 "./TypeChecking.ag" #-}

fixedValue :: a -> a -> a -> a
fixedValue a _ _ = a
{-# LINE 359 "AstInternal.hs" #-}

{-# LINE 698 "./TypeChecking.ag" #-}
