...
$(BUILD)/Database/HsSqlPpp/Tests/Parsing/ParserTests.o : hssqlppp/tests/Database/HsSqlPpp/Tests/Parsing/ParserTests.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            ...
            -package test-framework -package text -c \
...
$(BUILD)/Parse2.o : examples/Parse2.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -package text -c examples/Parse2.lhs -o \
            $(BUILD)/Parse2.o -i$(BUILD)/
...
$(BUILD)/Parse3.o : examples/Parse3.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -package text -c examples/Parse3.lhs -o \
            $(BUILD)/Parse3.o -i$(BUILD)/
...
$(BUILD)/Lex.o : examples/Lex.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -package text -c examples/Lex.lhs -o $(BUILD)/Lex.o \
            -i$(BUILD)/
...
$(BUILD)/TypeCheck3.o : examples/TypeCheck3.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -package text -c examples/TypeCheck3.lhs -o \
            $(BUILD)/TypeCheck3.o -i$(BUILD)/
...
$(BUILD)/Database/HsSqlPpp/Utils/GroomUtils.o : hssqlppp/tests/Database/HsSqlPpp/Utils/GroomUtils.lhs
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -package haskell-src-exts -c \
...
$(BUILD)/PPPTest.o : examples/PPPTest.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package Diff -package base -package text -c examples/PPPTest.lhs \
            -o $(BUILD)/PPPTest.o -i$(BUILD)/
...
$(BUILD)/Database/HsSqlPpp/Parsing/ParserInternal.o : hssqlppp/src/Database/HsSqlPpp/Parsing/ParserInternal.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -package mtl -package text -c \
...
$(BUILD)/Database/HsSqlPpp/Internals/AstInternal.o : hssqlppp/src/Database/HsSqlPpp/Internals/AstInternal.hs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -package mtl -package syb -package text -c \
...
$(BUILD)/Tests : $(BUILD)/Tests.o \
	...
	@$(HL) $(HL_OPTS) $(TESTS_EXTRA) \
            ...
            attoparsec -package base -package containers -package \
            haskell-src-exts -package mtl -package pretty -package syb \
            -package template-haskell -package test-framework -package text \
...
$(BUILD)/TestsTh : $(BUILD)/TestsTh.o \
	...
	@$(HL) $(HL_OPTS) $(TESTSTH_EXTRA) \
            ...
            $(BUILD)/Database/HsSqlPpp/Utility.o \
            $(BUILD)/Database/HsSqlPpp/Utils/Utils.o -package HUnit -package \
            attoparsec -package base -package containers -package mtl \
            -package pretty -package syb -package template-haskell -package \
            test-framework -package text -package transformers
...
$(BUILD)/MakeDefaultTemplate1Catalog : $(BUILD)/MakeDefaultTemplate1Catalog.o \
	...
	@$(HL) $(HL_OPTS) $(MAKEDEFAULTTEMPLATE1CATALOG_EXTRA) \
            ...
            bytestring -package containers -package mtl -package \
            template-haskell -package text -package transformers
...
$(BUILD)/MakeSelect : $(BUILD)/MakeSelect.o \
	...
	@$(HL) $(HL_OPTS) $(MAKESELECT_EXTRA) \
            ...
            containers -package mtl -package pretty -package syb -package \
            text -package transformers
...
$(BUILD)/Parse : $(BUILD)/Parse.o \
	...
	@$(HL) $(HL_OPTS) $(PARSE_EXTRA) \
            ...
            -package base -package containers -package mtl -package syb \
            -package text -package transformers
...
$(BUILD)/Parse2 : $(BUILD)/Parse2.o \
	...
	@$(HL) $(HL_OPTS) $(PARSE2_EXTRA) \
            ...
            $(BUILD)/Database/HsSqlPpp/Utils/GroomUtils.o \
            $(BUILD)/Database/HsSqlPpp/Utils/Utils.o -package attoparsec \
            -package base -package containers -package haskell-src-exts \
            -package mtl -package syb -package text -package transformers
...
$(BUILD)/TypeCheck3 : $(BUILD)/TypeCheck3.o \
	...
	@$(HL) $(HL_OPTS) $(TYPECHECK3_EXTRA) \
            ...
            $(BUILD)/Database/HsSqlPpp/Utils/Utils.o -package attoparsec \
            -package base -package containers -package haskell-src-exts \
            -package mtl -package syb -package template-haskell -package text \
            -package transformers
...
$(BUILD)/TypeCheckDB : $(BUILD)/TypeCheckDB.o \
	...
	@$(HL) $(HL_OPTS) $(TYPECHECKDB_EXTRA) \
            ...
            mtl -package syb -package template-haskell -package text -package \
            transformers
...
$(BUILD)/PPPTest : $(BUILD)/PPPTest.o \
	...
	@$(HL) $(HL_OPTS) $(PPPTEST_EXTRA) \
            ...
            attoparsec -package base -package containers -package mtl \
            -package pretty -package syb -package text -package transformers
...
$(BUILD)/QQ : $(BUILD)/QQ.o \
	...
	@$(HL) $(HL_OPTS) $(QQ_EXTRA) \
            ...
            $(BUILD)/Database/HsSqlPpp/SqlDialect.o \
            $(BUILD)/Database/HsSqlPpp/Utils/Utils.o -package attoparsec \
            -package base -package containers -package mtl -package pretty \
            -package syb -package template-haskell -package text -package \
            transformers
...
$(BUILD)/Reformat : $(BUILD)/Reformat.o \
	...
	@$(HL) $(HL_OPTS) $(REFORMAT_EXTRA) \
            ...
            $(BUILD)/Database/HsSqlPpp/Utils/Utils.o -package attoparsec \
            -package base -package containers -package mtl -package pretty \
            -package syb -package text -package transformers
