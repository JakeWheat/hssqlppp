...
$(BUILD)/Tests.o : hssqlppp/tests/Tests.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -c hssqlppp/tests/Tests.lhs -o $(BUILD)/Tests.o \
            -i$(BUILD)/
...
$(BUILD)/Database/HsSqlPpp/Tests/Tests.o : hssqlppp/tests/Database/HsSqlPpp/Tests/Tests.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -c hssqlppp/tests/Database/HsSqlPpp/Tests/Tests.lhs \
            -o $(BUILD)/Database/HsSqlPpp/Tests/Tests.o -i$(BUILD)/
...
$(BUILD)/Database/HsSqlPpp/Tests/Parsing/ParserTests.o : hssqlppp/tests/Database/HsSqlPpp/Tests/Parsing/ParserTests.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -package syb -package text -c \
...
$(BUILD)/TestsTh.o : hssqlppp-th/tests/TestsTh.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -c hssqlppp-th/tests/TestsTh.lhs -o \
            $(BUILD)/TestsTh.o -i$(BUILD)/
...
$(BUILD)/Database/HsSqlPpp/Internals/AstInternal.o : hssqlppp/src/Database/HsSqlPpp/Internals/AstInternal.hs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            ...
            text -c hssqlppp/src/Database/HsSqlPpp/Internals/AstInternal.hs \
            -o $(BUILD)/Database/HsSqlPpp/Internals/AstInternal.o -i$(BUILD)/
...
$(BUILD)/LexingTest.o : examples/LexingTest.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -package text -c examples/LexingTest.lhs -o \
            $(BUILD)/LexingTest.o -i$(BUILD)/
...
$(BUILD)/Tests : $(BUILD)/Tests.o \
	...
	@$(HL) $(HL_OPTS) $(TESTS_EXTRA) \
            ...
            containers -package groom -package haskell-src-exts -package mtl \
...
$(BUILD)/TestsTh : $(BUILD)/TestsTh.o \
	...
	@$(HL) $(HL_OPTS) $(TESTSTH_EXTRA) \
            ...
            syb -package template-haskell -package text -package transformers
...
$(BUILD)/MakeDefaultTemplate1Catalog : $(BUILD)/MakeDefaultTemplate1Catalog.o \
	...
	@$(HL) $(HL_OPTS) $(MAKEDEFAULTTEMPLATE1CATALOG_EXTRA) \
            ...
            -package split -package template-haskell -package text -package \
            transformers
...
$(BUILD)/MakeSelect : $(BUILD)/MakeSelect.o \
	...
	@$(HL) $(HL_OPTS) $(MAKESELECT_EXTRA) \
            ...
            $(BUILD)/Database/HsSqlPpp/Utils/Utils.o -package base -package \
            containers -package groom -package mtl -package pretty -package \
            syb -package text -package transformers
...
$(BUILD)/Parse : $(BUILD)/Parse.o \
	...
	@$(HL) $(HL_OPTS) $(PARSE_EXTRA) \
            ...
            $(BUILD)/Database/HsSqlPpp/SqlDialect.o \
            $(BUILD)/Database/HsSqlPpp/Utils/Utils.o -package base -package \
            containers -package groom -package mtl -package syb -package text \
...
$(BUILD)/Lex : $(BUILD)/Lex.o \
	...
	@$(HL) $(HL_OPTS) $(LEX_EXTRA) \
            ...
            $(BUILD)/Database/HsSqlPpp/LexicalSyntax.o \
            $(BUILD)/Database/HsSqlPpp/SqlDialect.o -package base -package \
            groom -package text
