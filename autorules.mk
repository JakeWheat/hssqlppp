...
$(BUILD)/PPPTest.o : examples/PPPTest.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -package text -c examples/PPPTest.lhs -o \
            $(BUILD)/PPPTest.o -i$(BUILD)/
...
$(BUILD)/Database/HsSqlPpp/Quote.o : hssqlppp-th/src/Database/HsSqlPpp/Quote.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -package template-haskell -package text -c \
            hssqlppp-th/src/Database/HsSqlPpp/Quote.lhs -o \
...
$(BUILD)/Database/HsSqlPpp/Parsing/ParserInternal.o : hssqlppp/src/Database/HsSqlPpp/Parsing/ParserInternal.lhs \
	...
	@$(HC) $(HC_OPTS) -hide-all-packages -outputdir $(BUILD)/ \
            -package base -package mtl -package parsec -package text -c \
...
$(BUILD)/Tests : $(BUILD)/Tests.o \
	...
	@$(HL) $(HL_OPTS) $(TESTS_EXTRA) \
            ...
            containers -package mtl -package parsec -package pretty -package \
...
$(BUILD)/MakeSelect : $(BUILD)/MakeSelect.o \
	...
	@$(HL) $(HL_OPTS) $(MAKESELECT_EXTRA) \
            ...
            $(BUILD)/Database/HsSqlPpp/SqlDialect.o \
            $(BUILD)/Database/HsSqlPpp/Utils/Utils.o -package base -package \
            containers -package mtl -package pretty -package text -package \
            transformers
...
$(BUILD)/Parse : $(BUILD)/Parse.o \
	...
	@$(HL) $(HL_OPTS) $(PARSE_EXTRA) \
            ...
            $(BUILD)/Database/HsSqlPpp/SqlDialect.o \
            $(BUILD)/Database/HsSqlPpp/Utils/Utils.o -package base -package \
            containers -package mtl -package parsec -package text -package \
            transformers
...
$(BUILD)/TypeCheck3 : $(BUILD)/TypeCheck3.o \
	...
	@$(HL) $(HL_OPTS) $(TYPECHECK3_EXTRA) \
            ...
            $(BUILD)/Database/HsSqlPpp/Utils/Here.o \
            $(BUILD)/Database/HsSqlPpp/Utils/Utils.o -package base -package \
            containers -package mtl -package parsec -package template-haskell \
...
$(BUILD)/TypeCheckDB : $(BUILD)/TypeCheckDB.o \
	...
	@$(HL) $(HL_OPTS) $(TYPECHECKDB_EXTRA) \
            ...
            $(BUILD)/Database/HsSqlPpp/Utils/PgUtils.o \
            $(BUILD)/Database/HsSqlPpp/Utils/Utils.o -package base -package \
            bytestring -package containers -package mtl -package parsec \
