...
sem_ArgsCheck (AllSameType _type )  =
    (sem_ArgsCheck_AllSameType _type )
sem_ArgsCheck (AllSameType1 _type )  =
    (sem_ArgsCheck_AllSameType1 _type )
...
sem_ArgsCheck (AllSameTypeNum _type _int )  =
    (sem_ArgsCheck_AllSameTypeNum _type _int )
...
wrap_ArgsCheck sem (Inh_ArgsCheck )  =
    (let ( ) =
             (sem )
     in  (Syn_ArgsCheck ))
sem_ArgsCheck_AllSameType :: Type ->
                             T_ArgsCheck 
sem_ArgsCheck_AllSameType type_  =
    (let 
     in  ( ))
sem_ArgsCheck_AllSameType1 :: Type ->
                              T_ArgsCheck 
...
sem_ArgsCheck_AllSameTypeAny  =
    (let 
     in  ( ))
sem_ArgsCheck_AllSameTypeNum :: Type ->
                                Int ->
                                T_ArgsCheck 
...
sem_RetType (ConstRetType _type )  =
    (sem_RetType_ConstRetType _type )
