...
type T_BinOp  = Bool ->
                MySourcePos ->
                ( ([Message]))
data Inh_BinOp  = Inh_BinOp {inLoop_Inh_BinOp :: Bool,sourcePos_Inh_BinOp :: MySourcePos}
data Syn_BinOp  = Syn_BinOp {messages_Syn_BinOp :: [Message]}
wrap_BinOp :: T_BinOp  ->
              Inh_BinOp  ->
              Syn_BinOp 
wrap_BinOp sem (Inh_BinOp _lhsIinLoop _lhsIsourcePos )  =
    (let ( _lhsOmessages) =
             (sem _lhsIinLoop _lhsIsourcePos )
    ...
    (\ _lhsIinLoop
       _lhsIsourcePos ->
         (let _lhsOmessages :: ([Message])
              ...
              ( _lowerImessages) =
                  (lower_ _lowerOinLoop _lowerOsourcePos )
              ( _upperImessages) =
                  (upper_ _upperOinLoop _upperOsourcePos )
          in  ( _lhsOmessages)))
       ...
       _lhsIsourcePos ->
         (let _lhsOmessages :: ([Message])
              ...
              _arg2OsourcePos =
                  _lhsIsourcePos
              ( _binOpImessages) =
                  (binOp_ _binOpOinLoop _binOpOsourcePos )
              ( _arg1Imessages) =
                  (arg1_ _arg1OinLoop _arg1OsourcePos )
              ( _arg2Imessages) =
                  (arg2_ _arg2OinLoop _arg2OsourcePos )
          in  ( _lhsOmessages)))
    ...
    (\ _lhsIinLoop
       _lhsIsourcePos ->
         (let _lhsOmessages :: ([Message])
              ...
              _statementOsourcePos :: MySourcePos
              _statementImessages :: ([Message])
              _lhsOmessages =
                  _statementImessages
              _statementOinLoop =
                  _lhsIinLoop
              _statementOsourcePos =
                  _lhsIsourcePos
              ( _statementImessages) =
                  (statement_ _statementOinLoop _statementOsourcePos )
          in  ( _lhsOmessages)))
       ...
       _lhsIsourcePos ->
         (let _lhsOmessages :: ([Message])
              ...
              _forOsourcePos =
                  _lhsIsourcePos
              ( _strImessages) =
                  (str_ _strOinLoop _strOsourcePos )
              ( _fromImessages) =
                  (from_ _fromOinLoop _fromOsourcePos )
              ( _forImessages) =
                  (for_ _forOinLoop _forOsourcePos )
          in  ( _lhsOmessages)))
       ...
       _lhsIsourcePos ->
         (let _lhsOmessages :: ([Message])
              ...
              _expressionOsourcePos =
                  _lhsIsourcePos
              ( _unOpImessages) =
                  (unOp_ _unOpOinLoop _unOpOsourcePos )
              ( _expressionImessages) =
                  (expression_ _expressionOinLoop _expressionOsourcePos )
          in  ( _lhsOmessages)))
...
type T_ExpressionListExpressionPair  = Bool ->
                                       MySourcePos ->
                                       ( ([Message]))
data Inh_ExpressionListExpressionPair  = Inh_ExpressionListExpressionPair {inLoop_Inh_ExpressionListExpressionPair :: Bool,sourcePos_Inh_ExpressionListExpressionPair :: MySourcePos}
...
wrap_ExpressionListExpressionPair sem (Inh_ExpressionListExpressionPair _lhsIinLoop _lhsIsourcePos )  =
    (let ( _lhsOmessages) =
             (sem _lhsIinLoop _lhsIsourcePos )
...
type T_ExpressionListExpressionPairList  = Bool ->
                                           MySourcePos ->
                                           ( ([Message]))
data Inh_ExpressionListExpressionPairList  = Inh_ExpressionListExpressionPairList {inLoop_Inh_ExpressionListExpressionPairList :: Bool,sourcePos_Inh_ExpressionListExpressionPairList :: MySourcePos}
...
wrap_ExpressionListExpressionPairList sem (Inh_ExpressionListExpressionPairList _lhsIinLoop _lhsIsourcePos )  =
    (let ( _lhsOmessages) =
             (sem _lhsIinLoop _lhsIsourcePos )
...
type T_UnOp  = Bool ->
               MySourcePos ->
               ( ([Message]))
data Inh_UnOp  = Inh_UnOp {inLoop_Inh_UnOp :: Bool,sourcePos_Inh_UnOp :: MySourcePos}
data Syn_UnOp  = Syn_UnOp {messages_Syn_UnOp :: [Message]}
wrap_UnOp :: T_UnOp  ->
             Inh_UnOp  ->
             Syn_UnOp 
wrap_UnOp sem (Inh_UnOp _lhsIinLoop _lhsIsourcePos )  =
    (let ( _lhsOmessages) =
             (sem _lhsIinLoop _lhsIsourcePos )
