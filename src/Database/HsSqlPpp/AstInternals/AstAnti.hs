...
data Statement = AlterSequence (Annotation) (String) (Expression)
               ...
               | Delete (Annotation) (Expression) (TableRefList)
               ...
               | Insert (Annotation) (Expression) ([String]) (SelectExpression)
                        (MaybeSelectList)
               ...
               | Update (Annotation) (Expression) (ExpressionList) (TableRefList)
                        (MaybeBoolExpression) (MaybeSelectList)
...
expression x
  = case x of
        ...
        QIdentifier a1 a2 a3 -> A.QIdentifier a1 (expression a2) a3
...
statement x
  = case x of
        ...
        Delete a1 a2 a3 a4 a5 -> A.Delete a1 (expression a2)
                                   (tableRefList a3)
        ...
        If a1 a2 a3 -> A.If a1 (expressionStatementListPairList a2)
                         (statementList a3)
        Insert a1 a2 a3 a4 a5 -> A.Insert a1 (expression a2) a3
                                   (selectExpression a4)
                                   (maybeSelectList a5)
        ...
        Truncate a1 a2 a3 a4 -> A.Truncate a1 a2 (restartIdentity a3)
                                  (cascade a4)
        Update a1 a2 a3 a4 a5 a6 -> A.Update a1 (expression a2)
                                      (expressionList a3)
                                      (tableRefList a4)
                                      (maybeBoolExpression a5)
                                      (maybeSelectList a6)
